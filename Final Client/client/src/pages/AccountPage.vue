          ...
          <q-card-section horizontal>
            <q-card-section class="q-pt-xs">
              ...
              <div class="text-caption text-grey">
                ...
                quod, illo id velit beatae eius quos, temporibus amet cum
                tempora minus adipisci hic iusto itaque ratione nobis dicta
                magnam sit.
...
export default defineComponent({
  ...
  setup() {
    const $q = useQuasar();
    const user = $q.cookies.get("client-user");
      ...
      async onSubmit() {
        try {
          await UserService.update(
            ...
            $q.cookies.set("client-user", user);
          });
